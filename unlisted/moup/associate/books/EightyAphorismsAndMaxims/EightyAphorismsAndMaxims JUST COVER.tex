...
\newcommand{\hexdot}{\raisebox{-0.15em}{\hspace{0.5ex}\includegraphics[height=1em]{tikz/hexdot.pdf}\hspace{0.5ex}}}
...
\newcommand{\eachpageornament}{%
	\begin{tikzpicture}[remember picture, overlay]
	\node[anchor=south, rotate=0] at ([shift=(0:0em)] current page.south){%
		\pgfornament[opacity=0.25, height=2\secheight]{69}};
	\node[anchor=south, rotate=180] at ([shift=(0:0em)] current page.north){%
		\pgfornament[opacity=0.25, height=2\secheight]{69}};
	\end{tikzpicture}
}
